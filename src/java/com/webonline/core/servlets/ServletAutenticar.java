...
public class ServletAutenticar extends HttpServlet{
    ...
    public void doPost(HttpServletRequest peticion, HttpServletResponse respuesta) 
        ...
        try {
            ...
            HttpPost post = new HttpPost("http://ec2-18-222-247-158.us-east-2.compute.amazonaws.com:9200/oauth/token");
            post.addHeader("Authorization", "Basic YWxtYWNlbjpAbG1hYzNu");
            post.addHeader("Content-Type", "application/x-www-form-urlencoded");
            
            List<NameValuePair> parameters = new ArrayList<NameValuePair>();
            parameters.add(new BasicNameValuePair("username", "maguirre"));
